...
NoBuyRecruitSell()
{
	Loop 500
	{
		...
		if (FindClick(PNGPath . "FC_SellScrConfirm.png", "n") != 0)
		{
			...
			DebugMessage("Sell Four ABORTED")
...
;	DebugMessage("ScrollToAC Enter")
		...
		while (FindClick(PNGPath . "FC_AC2000_v3.png", "n oTransBlack") = 0)
		{
			...
			; scroll glitched, reset ringshop
			SetMouseDelay 0
			if (Mod(itr, 20) = 0)
			{
				if (Mod(itr, 60) = 0)
				{
					DebugMessage("ScrollToAC Glitched Rescue & Reenter")
					Rescue()
					GotoRingShopItems()
				}
				else
				{
					DebugMessage("ScrollToAC Glitched Reenter Shop")
					GotoRingShopItems()
				}
			}
			SetMouseDelay 100
...
Rescue()
{
	...
	Loop 5
	{
		...
		Else
		{
			DebugMessage("Rescue Android-Back")
			Click 50, 900
			Continue
		}
	}
...
;	DebugMessage("Sell Four Exit")
	Return
}

ExitSell()
{
;	DebugMessage("Exit Sell Enter")

	Click 1280, 790
	Sleep 2000

;	DebugMessage("Exit Sell Exit")
	Return
}

ScrollToChallengeRecruit()
{
;	DebugMessage("Scroll To ChallengeRec Enter")
	SendMode Event
	SetMouseDelay 100
...
;	DebugMessage("Scroll To ChallengeRec Exit")
	Return
}

GotoSell()
{
;	DebugMessage("GotoSell Enter")
...
GotoRingShopItems()
{
;	DebugMessage("GotoRingShopItems Enter")
	GotoRecruit()
	Click 395 80	;ringshop
	Sleep 3000
	Click 480 200	;items
	Sleep 2500
;	DebugMessage("GotoRingShopItems Enter")
...
GotoRecruit()
{
;	DebugMessage("GotoRecruit Enter")
	Click 1360 70	;map
	Sleep 3000
	Click 882 816	;menu
	Sleep 500
	Click 806 802	;recruit
	Sleep 3000
;	DebugMessage("GotoRecruit Enter")
	Return
}
...
;	DebugMessage("DoChallengeRec Exit")
	Return
}
...
DebugConsoleInitialize()
{
   ...
   WinActivate, BlueStacks App Player  ; Application specific; I need to make sure this application is running in the foreground. YMMV
   return
}
